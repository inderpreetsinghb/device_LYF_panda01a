...
TARGET_KERNEL_SOURCE := kernel/LYF/msm8976
TARGET_KERNEL_CONFIG := lineage_panda01a_defconfig
...
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_panda01a
TARGET_RECOVERY_DEVICE_MODULES := //$(DEVICE_PATH):libinit_panda01a
